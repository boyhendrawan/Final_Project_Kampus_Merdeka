  ...
  return (
    <form action="">
      <div className='my-4 grid gap-4 md:grid-cols-2 mb-4'>
        ...
        <div>
          <label htmlFor="nameFamily" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name Family</label>
        ...
        <div>
          <label htmlFor="numberPhone" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Number Phone</label>
        ...
        <div>
          <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Personal Email</label>
          <input readOnly type="email" name="email" id="email" className="bg-gray-50 font-base border transition-all  border-gray-300 text-gray-900 text-sm rounded-lg  focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="email.example" required=""/>
        </div>
        

      </div>
      <div className='flex justify-end w-full'>
        <button onClick={handleNext} className='bg-blue-500 px-4 py-2 hover:bg-blue-600 rounded-lg text-white'>Next</button>
      </div>
    </form>
  )
}
