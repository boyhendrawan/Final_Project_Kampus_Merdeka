    ...
    <div className="w-11/12 h-11/12 ml-[1.5rem]">
      ...
      <div className="flex flex-col max-w-sm mt-6 font-semibold md:ml-[10rem]">
        <div className="border-b border-slate-500 w-11/12 flex items-center py-4 cursor-pointer">
          <TbPencilMinus className="text-primary-main mr-2" size="30px" />
        ...
        <div className="border-b border-slate-500 w-11/12 flex items-center py-4">
          <FiSettings className="text-primary-main mr-2" size="30px" />
          <button className="flex items-center gap-2">Pengaturan Akun</button>
        </div>
        <div className="border-b border-slate-500 w-11/12 flex items-center py-4">
          <ImExit className="text-primary-main mr-2" size="30px" />
          ...
          <div className="w-10/12 bg-white rounded-lg p-6">
            ...
            <div className="w-9/12 mx-auto mt-4 rounded-lg">
              ...
              >
                <label
                  htmlFor="fullName"
                  className="text-xs text-primary-main mt-3"
                >
                  Nama Lengkap
                </label>
                <input
                ...
                <input
                  ...
                  onChange={handleInputChange}
                />
                <label htmlFor="email" className="text-xs text-primary-main">
                  Email
                </label>
                <input
                  type="text"
                ...
                <button
                  type="submit"
                  className="bg-primary-main text-white p-2 w-10/12 mx-auto mt-5 rounded-lg mb-3"
                >
                  Simpan
                </button>
              </form>
              <button
                className="text-sm text-primary-main underline"
                onClick={closeModal}
              >
                Batal
              </button>
