  ...
  return (
    ...
    <div>
      ...
      <div className='  w-full grid grid-cols-2  gap-x-5 gap-y-1 mt-6 mb-4  '>
        ...
        <div className='flex flex-col gap-y-2  text-xs md:text-base lg:text-base text-gray-500  '>
          <p className=''>Hello, <span className='font-bold'>{personal.fullName}</span></p>
          <p className=''>{personal.numberPhone}</p>
        </div>
        <div className='flex flex-col gap-y-2 justify-self-end text-xs md:text-base lg:text-base text-gray-500 '>
        ...
        <Accordion collapseAll className='col-span-2 border-none flex flex-col gap-y-2'>
          {pessegers.map(e => {
